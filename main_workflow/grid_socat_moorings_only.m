% Grid SOCAT mooring observations only
% 
...
%% display status
disp('Gridding SOCAT observations (moorings only)');
...
exportgraphics(gcf,'Figures/obs_moorings_only.png');
close
...
% save figure
if ~isfolder('Figures'); mkdir('Figures'); end
exportgraphics(gcf,'Figures/fCO2_moorings_only.png');
close

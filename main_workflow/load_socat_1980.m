...
% Last updated by J.D. Sharp: 4/3/23
% 
...
%% remove observations before 1980
idxyr = SOCAT.year >= 1980;
...
%% determine months since Jan 1 1980
SOCAT.month_since_1980 = ...
    (SOCAT.year-1980).*12 + SOCAT.month;
...
exportgraphics(gcf,'Figures/hist_NA_1980.png');
close

%% Save SOCAT structure
if ~isfolder('Data'); mkdir('Data'); end
save('Data/socat_structure_1980','SOCAT','-v7.3');
